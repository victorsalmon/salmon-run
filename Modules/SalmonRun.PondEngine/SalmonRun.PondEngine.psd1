@{
    ...
    FunctionsToExport = @('Get-SalmonRunPonds', 'Start-PondEngine', 'Invoke-PondLanePipeline', 'New-PondStream', 'New-SalmonProjectPlan', 'Get-PlanPondLog', 'Add-PlanPondLog', 'Get-SalmonRunPlanSchema')
    CmdletsToExport = @()
    VariablesToExport = @()
    AliasesToExport = @()
    PrivateData = @{ PSData = @{ } }
