...
- **Format**: `v<major>.<minor>.<patch>` (e.g. `v0.1.3`)
...
The public `salmon-run` package was validated at `v0.1.3` on 2026-08-27:

- Docker image built locally as `salmon-run:0.1.3` and `docker run --rm salmon-run:0.1.3 -DryRun` produced the expected queue listing.
