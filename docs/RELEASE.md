...
The public `salmon-run` package was validated at `v0.1.2` on 2026-08-27:

- Docker image built locally as `salmon-run:0.1.2` and `docker run --rm salmon-run:0.1.2 -DryRun` produced the expected queue listing.
