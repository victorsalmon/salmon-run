<#
.DEPRECATED
    Renamed to Invoke-PrpStep9-CategorizationAudit.ps1 (PRP reorder — moved
    to post-recon position). This file kept for backward compatibility.
.SYNOPSIS
    DEPRECATED — PRP Step 3: Audit categorization of all transactions.
.DESCRIPTION
...
.EXAMPLE
    Invoke-PrpStep3-CategorizationAudit.ps1 -ZohoAll $zohoAll -UncatTxns $uncatTxns
#>
