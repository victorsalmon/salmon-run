...
async function main() {
  ...
  console.log("Period Apr 9 – May 9, 2025 (May 9 gap = -$51.45):");
  console.log("Zoho transactions:");
  for (const t of allTxns) {
    if (t.date > "2025-04-09" && t.date <= "2025-05-09") {
  ...
  console.log("\nBank statement sidecar (May 9, 2025):");
}
