function Test-FleetSelfHealth {
    ...
    .OUTPUTS
        System.Object[]
    .NOTES
        Timeout chain: Invoke-RestMethod -TimeoutSec 5 (single call, no outer wrapper).
        Called from Invoke-FleetHealthCheck (sequential execution, no cumulative timeout).
    #>
    [OutputType([array])]
