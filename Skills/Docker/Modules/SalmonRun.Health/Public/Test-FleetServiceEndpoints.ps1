...
function Test-FleetServiceEndpoints {
    ...
    <#
    .NOTES
        Timeout chain: Up to 7 sequential Invoke-WebRequest calls, each -TimeoutSec 10.
        Worst-case chain sum: 70s. Called from Invoke-FleetHealthCheck (sequential, no cumulative timeout).
    #>
