...
function Get-SalmonRunPonds {
    ...
    $ponds += New-Pond -Name 'Audit' -Folder 'Tasks/Audit' -Role 'auditor' -Description 'Best-practice, safety, and code-smell review' -ParallelCount 1 -MaxNewPerIteration 1 -GroupBy 'Namespace' -Tasks @(
        [PondTask]@{ Name = 'Claim'; Type = 'Group'; Function = 'Invoke-PondTaskClaim' }
        [PondTask]@{ Name = 'Prepare'; Type = 'PerFile'; Function = 'Invoke-PondTaskPrepare' }
        [PondTask]@{ Name = 'ModelRoute'; Type = 'Group'; Function = 'Invoke-PondTaskModelRoute' }
    ...
    $ponds += New-Pond -Name 'QA' -Folder 'Tasks/QA' -Role 'qa' -Description 'Property and mutation test maturation' -ParallelCount 1 -MaxNewPerIteration 1 -GroupBy 'Namespace' -Tasks @(
        [PondTask]@{ Name = 'Claim'; Type = 'Group'; Function = 'Invoke-PondTaskClaim' }
        [PondTask]@{ Name = 'Prepare'; Type = 'PerFile'; Function = 'Invoke-PondTaskPrepare' }
        [PondTask]@{ Name = 'ModelRoute'; Type = 'Group'; Function = 'Invoke-PondTaskModelRoute' }
